...
@section('admin_content')
    <form action="{{ URL::to('Admin/update-holiday-event/' . $holidayEvent->holiday_event_id) }}" method="POST"
        ...
        <div class="header-title">
            <div class="">
                <h3 class="title-content">Chỉnh sửa sự kiện</h3>
                <ol class="breadcrumb">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="event_end_date" id="event_end_date" class="form-control" required
                                value="{{ $holidayEvent->event_end_date }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="event_status">
                                <option value="1" {{ $holidayEvent->event_status == '1' ? 'selected' : '' }}>Hiển thị
                                </option>
                                <option value="0" {{ $holidayEvent->event_status == '0' ? 'selected' : '' }}>Ẩn
                                </option>
                            </select>
                        </div>
                    </div>
